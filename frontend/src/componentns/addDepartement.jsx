...
export default function AddDepartement() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:3000/departements', {
                ...formData,
                facultyId: Number(formData.facultyId),
            });
            console.log('Departement add successful');
            window.location.href = '/Departements';
        } catch (error) {
            if (error.response) {
                console.error('add  failed:', error.response.data.message);
            } else {
                console.error('add departement failed. No response from the server.');
            }
        }
    };
                        ...
                        <div className="formbg-outer">
                            <div className="formbg">
                                <div className="formbg-inner padding-horizontal--48">
                                    <span className="padding-bottom--15">Add Departement</span>
